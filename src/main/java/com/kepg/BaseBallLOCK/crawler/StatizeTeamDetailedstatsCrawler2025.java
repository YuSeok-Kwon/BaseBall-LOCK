...
public class StatizeTeamDetailedstatsCrawler2025 {
    ...
    private static final String baseUrl = "https://statiz.sporki.com/stats/?m=team&m2=%s&m3=default&so=WAR&ob=DESC&year=%d"
    ...
    private static final String[] types = {"batting", "pitching"};
    private static final int[] years = {2025};
