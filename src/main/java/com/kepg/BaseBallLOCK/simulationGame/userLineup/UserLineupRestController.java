package com.kepg.BaseBallLOCK.simulationGame.userLineup;
...
public class UserLineupRestController {
    ...
    @GetMapping
    public List<UserLineup> getLineup(HttpSession session) {
        Integer userId = (Integer) session.getAttribute("userId");
        return userLineupService.getLineupByUserId(userId);
    }
